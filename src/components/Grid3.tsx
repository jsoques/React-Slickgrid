...
export default class Grid3 extends Component<Props, State> {
    ...
    this.columnDefinitions = [
      {
        ...
        grouping: {
          getter: 'title',
          formatter: (g) =>
            `Title: ${g.value} <span style="color:green">(${g.count} items)</span>`,
      ...
      },
      {
        ...
        grouping: {
          getter: 'cost',
          formatter: (g) =>
            `Cost: ${g.value} <span style="color:green">(${g.count} items)</span>`,
          aggregators: [new Aggregators.Sum('cost')],
      ...
      },
      {
        ...
        grouping: {
          getter: 'start',
          formatter: (g) =>
            `Start: ${g.value} <span style="color:green">(${g.count} items)</span>`,
          aggregators: [new Aggregators.Sum('cost')],
          aggregateCollapsed: false,
          collapsed: false
        }
      },
      {
        ...
        grouping: {
          getter: 'finish',
          formatter: (g) =>
            `Finish: ${g.value} <span style="color:green">(${g.count} items)</span>`,
          aggregators: [new Aggregators.Sum('cost')],
          aggregateCollapsed: false,
          collapsed: false
        }
  ...
  toggleDraggableGroupingRow = () => {
    ...
    this.sgb?.slickGrid.setPreHeaderPanelVisibility(
      !this.sgb?.slickGrid.getOptions().showPreHeaderPanel
    );
  };
